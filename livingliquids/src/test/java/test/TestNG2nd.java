...
public class TestNG2nd {
	private WebDriver driver;
	private Liquid_Headers1 liquid_Headers1;
	...
	public void beforeclass() {
		 liquid_Headers1 = new Liquid_Headers1(driver);
		 whiskey=new Whiskey(driver);
	...
	@Test (timeOut=4000)           // actual test cases is been written here
	...
	@AfterTest // it is used to close/quit the browser
